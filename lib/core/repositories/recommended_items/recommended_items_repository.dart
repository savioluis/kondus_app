// lib/src/modules/share_your_items/data/recommended_items_repository.dart

import 'package:kondus/core/services/items/models/items_filter_model.dart';
import 'package:kondus/src/modules/share_your_items/model/recommended_item.dart';

class RecommendedItemsRepository {
  const RecommendedItemsRepository();

  List<RecommendedItem> getRecommendedItems() {
    return [
      RecommendedItem(
      ...
      RecommendedItem(
        ...
        type: ItemType.servico,
        description:
            "Ensino prático e teórico de guitarra elétrica e acústica.",
        categoriesIds: [14],
        actionType: "Serviço",
      ),
      RecommendedItem(
      ...
      RecommendedItem(
        ...
        type: ItemType.produto,
        description:
            "Para aproveitar as áreas abertas e calçadas do condomínio.",
        categoriesIds: [7],
        actionType: "Aluguel",
      ),
      RecommendedItem(
      ...
      RecommendedItem(
        ...
        type: ItemType.produto,
        description:
            "Baldinhos e pazinhas para brincar na areia do playground.",
        categoriesIds: [7],
        actionType: "Aluguel",
      ),
      RecommendedItem(
        ...
        type: ItemType.produto,
        description:
            "Perfeito para partidas com os vizinhos no salão de jogos.",
        categoriesIds: [7],
        actionType: "Aluguel",
      ),
    ];
